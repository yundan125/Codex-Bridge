...
仅支持 QQ 官方平台当前开放的文本 C2C 与群聊 @机器人事件。production 是当前支持环境；应用必须在 QQ 开放平台取得对应事件/Intent 权限。无图片、文件、语音、视频、频道扩展、好友/群管理、远程 Approval、新 Thread、Fork、持久队列、自动重发 Prompt、安装包或自动更新。
